...
define('fly',['jquery', 'queryparams', 'jquerycookie'], function ($) {
	// Copy from Olex.
...
define('router',['backbone', 'jquery', 'fly', 'underscore'] ,function (backbone, $, fly, _) {
	return {
		initialize: function () {
			var appRoutes = {},
				appHandlers = {},
    ...
    define('text',[],function () {
        ...
        typeof window !== "undefined" && window.navigator && window.document ? h = function (a, b) {
            ...
            try {
                ...
                (f = c.readLine()) && f.length() && f.charAt(0) === 65279 && (f = f.substring(1));
                for (d.append(f);
...
define('text!app.xml',[],function () { return '<app name="htmlflyfly">\n\t<theme name="default" folder="theme/"></theme>\n\t<modules>\n\t\t<!-- 系统模块 -->\n\t\t<module folder="app/">user</module>\n\t\t<module folder="app/">system</module>\n\t</modules>\n\t<plugins>\n\t\t<plugin folder="plugins" entry="plugin" name="example" />\n\t\t<plugin folder="plugins" entry="user" name="user" />\n\t</plugins>\n</app>';});
...
define('app',['router', 'jquery', 'fly', 'text!app.xml', 'layoutmanager'], function (Router, $, fly, appXML) {
...
define('bootstrap.js',['./config', './app'], function (config, App) {
	App.initialize();
});
